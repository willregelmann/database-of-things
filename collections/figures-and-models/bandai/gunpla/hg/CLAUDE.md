...
dedup — true unique counts will be lower, HGUC's own 546→330 ratio is a
rough guide): HGGS/Gundam SEED original (149), HG00/Gundam 00 (138),
HGGTO/08th MS Team-Thunderbolt era (124), HGI-BO/Iron-Blooded Orphans
(120), HGCE/Cosmic Era current-era (101), HGAGE/Gundam AGE (80), HGBF/
...
count; HGUC's 546 raw pages resolved to 330 real unique kits.
...
referenced but with no page written yet), not real gaps.
...
no number prefix, no `variants` sub-entities, sourcing method, unreleased/
`{{Canceled}}` kit checks) follows [`../rg/CLAUDE.md`](../rg/CLAUDE.md),
[`../eg/CLAUDE.md`](../eg/CLAUDE.md), [`../pg/CLAUDE.md`](../pg/CLAUDE.md),
and [`../sd/CLAUDE.md`](../sd/CLAUDE.md) — see `hguc/CLAUDE.md` for
HGUC-specific numbers.
