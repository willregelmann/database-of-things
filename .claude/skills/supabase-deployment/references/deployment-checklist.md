...
**Why**: Makes the database portable across environments. Clients prepend the Supabase project URL to these relative paths.
...
### 7. Push Migrations to Production
...
- Creates indexes
- Creates database functions (search_by_text)
- Creates storage bucket and policies

### 8. Import Data to Production
...
- ✅ Functions exist (search_by_text)
...
- **Storage URLs**: Portable relative paths work automatically with production

### 14. Configure Row-Level Security (Optional)
...
2. Verify image URLs are relative paths (no localhost)
